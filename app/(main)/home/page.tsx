      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {/* Feature 1 */}
            <div className="bg-gradient-to-br from-violet-50 to-white p-5 rounded-xl border border-violet-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="bg-violet-100 text-violet-600 w-12 h-12 rounded-xl flex items-center justify-center mb-3">
              ...
              <Link
                href="/tournaments"
                className="text-violet-600 font-medium flex items-center hover:text-violet-700 text-sm"
              >
                Ver torneos
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-white p-5 rounded-xl border border-emerald-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="bg-emerald-100 text-emerald-600 w-12 h-12 rounded-xl flex items-center justify-center mb-3">
              ...
              <Link
                href="/ranking"
                className="text-emerald-600 font-medium flex items-center hover:text-emerald-700 text-sm"
              >
                Ver ranking
                <ChevronRight className="h-4 w-4 ml-1" />
              </Link>
            ...
            {/* Feature 3 */}
            <div className="bg-gradient-to-br from-amber-50 to-white p-5 rounded-xl border border-amber-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="bg-amber-100 text-amber-600 w-12 h-12 rounded-xl flex items-center justify-center mb-3">
              ...
              <Link
                href="/clubes"
                className="text-amber-600 font-medium flex items-center hover:text-amber-700 text-sm"
              >
                Explorar clubes
                <ChevronRight className="h-4 w-4 ml-1" />
              </Link>
            ...
            {/* Feature 5 */}
            <div className="bg-gradient-to-br from-rose-50 to-white p-5 rounded-xl border border-rose-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="bg-rose-100 text-rose-600 w-12 h-12 rounded-xl flex items-center justify-center mb-3">
              ...
              <Link
                href="/calendar"
                className="text-rose-600 font-medium flex items-center hover:text-rose-700 text-sm"
              >
                Ver calendario
                <ChevronRight className="h-4 w-4 ml-1" />
              </Link>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-white p-5 rounded-xl border border-purple-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="bg-purple-100 text-purple-600 w-12 h-12 rounded-xl flex items-center justify-center mb-3">
              ...
              <Link
                href="/stats"
                className="text-purple-600 font-medium flex items-center hover:text-purple-700 text-sm"
              >
                Ver estadísticas
                <ChevronRight className="h-4 w-4 ml-1" />
              </Link>
        ...
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-r from-violet-600 to-emerald-500 rounded-2xl overflow-hidden shadow-lg">
            <div className="px-6 py-8 md:p-10 text-center text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Button asChild size="default" className="bg-white text-violet-600 hover:bg-white/90 rounded-xl">
                  <Link href="/register">
